...
public class ArduinoUsbService extends Service implements ArduinoUsbDrivers.ArduinoListners, Observer {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.getAction().equals(Constants.ACTION.STARTFOREGROUND_ACTION)) {
            ...
            Intent reconnectIntent = new Intent(this, ArduinoUsbService.class);
            reconnectIntent.setAction(Constants.ACTION.RECONNECT_ACTION);
            PendingIntent reconnect = PendingIntent.getService(this, 0,
                    reconnectIntent, 0);

            Intent disconnectIntent = new Intent(this, ArduinoUsbService.class);
